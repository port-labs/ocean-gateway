...
// payloadLogValue returns a slog-friendly representation of the webhook body.
// Valid JSON is unmarshaled so fields appear nested under payload in structured logs.
// Non-JSON bodies log as an empty payload.
